...
{     
    ...
    {
        // Retrieve all ImportExportPermit instances where 'is_import' is 1 and eager load the relationship 'import_export_permits_has_crops' along with the 'crop_variety' relationship
        $forms = ImportExportPermit::where('is_import', 1)
    ...
    public function destroy($id)
    {
        ...
        $form = ImportExportPermit::where('id', $id)->where('is_import', 1)->firstOrFail();
