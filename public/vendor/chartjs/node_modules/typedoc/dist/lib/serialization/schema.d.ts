...
export declare type SomeType = ArrayType | ConditionalType | IndexedAccessType | InferredType | IntersectionType | IntrinsicType | LiteralType | OptionalType | PredicateType | QueryType | ReferenceType | ReflectionType | RestType | TupleType | TypeOperatorType | UnionType | UnknownType;
