...
const StatementTypes = {
    ...
    break: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.BreakStatement, 'break'),
    case: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.SwitchCase, 'case'),
    class: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.ClassDeclaration, 'class'),
    const: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.VariableDeclaration, 'const'),
    continue: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.ContinueStatement, 'continue'),
    debugger: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.DebuggerStatement, 'debugger'),
    default: newKeywordTester([experimental_utils_1.AST_NODE_TYPES.SwitchCase, experimental_utils_1.AST_NODE_TYPES.ExportDefaultDeclaration], 'default'),
    do: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.DoWhileStatement, 'do'),
    ...
    if: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.IfStatement, 'if'),
    import: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.ImportDeclaration, 'import'),
    let: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.VariableDeclaration, 'let'),
    return: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.ReturnStatement, 'return'),
    switch: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.SwitchStatement, 'switch'),
    throw: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.ThrowStatement, 'throw'),
    try: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.TryStatement, 'try'),
    var: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.VariableDeclaration, 'var'),
    while: newKeywordTester([experimental_utils_1.AST_NODE_TYPES.WhileStatement, experimental_utils_1.AST_NODE_TYPES.DoWhileStatement], 'while'),
    with: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.WithStatement, 'with'),
    // Additional Typescript constructs
    interface: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.TSInterfaceDeclaration, 'interface'),
    type: newKeywordTester(experimental_utils_1.AST_NODE_TYPES.TSTypeAliasDeclaration, 'type'),
};
//------------------------------------------------------------------------------
// Rule Definition
//------------------------------------------------------------------------------
