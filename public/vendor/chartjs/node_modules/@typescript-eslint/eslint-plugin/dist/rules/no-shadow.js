...
exports.default = util.createRule({
    ...
    create(context, [options]) {
        ...
        function isTypeImport(definition) {
            return ((definition === null || definition === void 0 ? void 0 : definition.type) === scope_manager_1.DefinitionType.ImportBinding &&
                (definition.parent.importKind === 'type' ||
                    (definition.node.type === experimental_utils_1.AST_NODE_TYPES.ImportSpecifier &&
        ...
        function isImportDeclaration(definition) {
            return definition.type === experimental_utils_1.AST_NODE_TYPES.ImportDeclaration;
        }
        function isExternalModuleDeclarationWithName(scope, name) {
            return (scope.type === scope_manager_1.ScopeType.tsModule &&
                scope.block.type === experimental_utils_1.AST_NODE_TYPES.TSModuleDeclaration &&
                scope.block.id.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
        ...
        function isExternalDeclarationMerging(scope, variable, shadowed) {
            ...
            return (isTypeImport(firstDefinition) &&
                ...
                secondDefinition.node.type === experimental_utils_1.AST_NODE_TYPES.TSInterfaceDeclaration &&
        ...
        function checkForShadows(scope) {
            ...
            for (const variable of variables) {
                ...
                const shadowed = scope.upper
                    ? experimental_utils_1.ASTUtils.findVariable(scope.upper, variable.name)
                    : null;
                if (!shadowed) {
                    continue;
                }
