...
exports.default = util.createRule({
    ...
    create(context, [option]) {
        ...
        function checkMethodAccessibilityModifier(methodDefinition) {
            if (methodDefinition.key.type === experimental_utils_1.AST_NODE_TYPES.PrivateIdentifier) {
                return;
            }
        ...
        function checkPropertyAccessibilityModifier(propertyDefinition) {
            if (propertyDefinition.key.type === experimental_utils_1.AST_NODE_TYPES.PrivateIdentifier) {
                return;
            }
