var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},t={},r={};!function(e){function t(t){return e.$0<=t&&t<=e.$9}
/**
   * @license
 ...
 * found in the LICENSE file at https://angular.io/license
 */
Object.defineProperty(Mc,"__esModule",{value:!0});const Uc=jc;class Gc{constructor(){let{closedByChildren:e,implicitNamespacePrefix:t,contentType:r=Uc.TagContentType.PARSABLE_DATA,closedByParent:n=!1,isVoid:i=!1,ignoreFirstLf:s=!1}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};this.closedByChildren={},this.closedByParent=!1,this.canSelfClose=!1,e&&e.length>0&&e.forEach((e=>this.closedByChildren[e]=!0)),this.isVoid=i,this.closedByParent=n||i,this.implicitNamespacePrefix=t||null,this.contentType=r,this.ignoreFirstLf=s}isClosedByChild(e){return this.isVoid||e.toLowerCase()in this.closedByChildren}}let Vc,Xc;Mc.HtmlTagDefinition=Gc,Mc.getHtmlTagDefinition=function(e){return Xc||(Vc=new Gc,Xc={base:new Gc({isVoid:!0}),meta:new Gc({isVoid:!0}),area:new Gc({isVoid:!0}),embed:new Gc({isVoid:!0}),link:new Gc({isVoid:!0}),img:new Gc({isVoid:!0}),input:new Gc({isVoid:!0}),param:new Gc({isVoid:!0}),hr:new Gc({isVoid:!0}),br:new Gc({isVoid:!0}),source:new Gc({isVoid:!0}),track:new Gc({isVoid:!0}),wbr:new Gc({isVoid:!0}),p:new Gc({closedByChildren:["address","article","aside","blockquote","div","dl","fieldset","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","main","nav","ol","p","pre","section","table","ul"],closedByParent:!0}),thead:new Gc({closedByChildren:["tbody","tfoot"]}),tbody:new Gc({closedByChildren:["tbody","tfoot"],closedByParent:!0}),tfoot:new Gc({closedByChildren:["tbody"],closedByParent:!0}),tr:new Gc({closedByChildren:["tr"],closedByParent:!0}),td:new Gc({closedByChildren:["td","th"],closedByParent:!0}),th:new Gc({closedByChildren:["td","th"],closedByParent:!0}),col:new Gc({isVoid:!0}),svg:new Gc({implicitNamespacePrefix:"svg"}),math:new Gc({implicitNamespacePrefix:"math"}),li:new Gc({closedByChildren:["li"],closedByParent:!0}),dt:new Gc({closedByChildren:["dt","dd"]}),dd:new Gc({closedByChildren:["dt","dd"],closedByParent:!0}),rb:new Gc({closedByChildren:["rb","rt","rtc","rp"],closedByParent:!0}),rt:new Gc({closedByChildren:["rb","rt","rtc","rp"],closedByParent:!0}),rtc:new Gc({closedByChildren:["rb","rtc","rp"],closedByParent:!0}),rp:new Gc({closedByChildren:["rb","rt","rtc","rp"],closedByParent:!0}),optgroup:new Gc({closedByChildren:["optgroup"],closedByParent:!0}),option:new Gc({closedByChildren:["option","optgroup"],closedByParent:!0}),pre:new Gc({ignoreFirstLf:!0}),listing:new Gc({ignoreFirstLf:!0}),style:new Gc({contentType:Uc.TagContentType.RAW_TEXT}),script:new Gc({contentType:Uc.TagContentType.RAW_TEXT}),title:new Gc({contentType:Uc.TagContentType.ESCAPABLE_RAW_TEXT}),textarea:new Gc({contentType:Uc.TagContentType.ESCAPABLE_RAW_TEXT,ignoreFirstLf:!0})}),Xc[e]||Vc};var Hc={},zc={},Wc={};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
Object.defineProperty(zc,"__esModule",{value:!0});const Yc=Wc;zc.Text=class{constructor(e,t,r){this.value=e,this.sourceSpan=t,this.i18n=r,this.type="text"}visit(e,t){return e.visitText(this,t)}};zc.CDATA=class{constructor(e,t){this.value=e,this.sourceSpan=t,this.type="cdata"}visit(e,t){return e.visitCdata(this,t)}};zc.Expansion=class{constructor(e,t,r,n,i,s){this.switchValue=e,this.type=t,this.cases=r,this.sourceSpan=n,this.switchValueSourceSpan=i,this.i18n=s}visit(e,t){return e.visitExpansion(this,t)}};zc.ExpansionCase=class{constructor(e,t,r,n,i){this.value=e,this.expression=t,this.sourceSpan=r,this.valueSourceSpan=n,this.expSourceSpan=i}visit(e,t){return e.visitExpansionCase(this,t)}};zc.Attribute=class{constructor(e,t,r){let n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;this.name=e,this.value=t,this.sourceSpan=r,this.valueSpan=n,this.nameSpan=i,this.i18n=s,this.type="attribute"}visit(e,t){return e.visitAttribute(this,t)}};class Qc{constructor(e,t,r,n){let i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,o=arguments.length>6&&void 0!==arguments[6]?arguments[6]:null,a=arguments.length>7&&void 0!==arguments[7]?arguments[7]:null;this.name=e,this.attrs=t,this.children=r,this.sourceSpan=n,this.startSourceSpan=i,this.endSourceSpan=s,this.nameSpan=o,this.i18n=a,this.type="element"}visit(e,t){return e.visitElement(this,t)}}zc.Element=Qc;zc.Comment=class{constructor(e,t){this.value=e,this.sourceSpan=t,this.type="comment"}visit(e,t){return e.visitComment(this,t)}};function Jc(e,t){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;const n=[],i=e.visit?t=>e.visit(t,r)||t.visit(e,r):t=>t.visit(e,r);return t.forEach((e=>{const t=i(e);t&&n.push(t)})),n}zc.DocType=class{constructor(e,t){this.value=e,this.sourceSpan=t,this.type="docType"}visit(e,t){return e.visitDocType(this,t)}},zc.visitAll=Jc;class Zc{constructor(){}visitElement(e,t){this.visitChildren(t,(t=>{t(e.attrs),t(e.children)}))}visitAttribute(e,t){}visitText(e,t){}visitCdata(e,t){}visitComment(e,t){}visitDocType(e,t){}visitExpansion(e,t){return this.visitChildren(t,(t=>{t(e.cases)}))}visitExpansionCase(e,t){}visitChildren(e,t){let r=[],n=this;return t((function(t){t&&r.push(Jc(n,t,e))})),Array.prototype.concat.apply([],r)}}function Kc(e){const t=e.sourceSpan.start.offset;let r=e.sourceSpan.end.offset;return e instanceof Qc&&(e.endSourceSpan?r=e.endSourceSpan.end.offset:e.children&&e.children.length&&(r=Kc(e.children[e.children.length-1]).end)),{start:t,end:r}}zc.RecursiveVisitor=Zc,zc.findNode=function(e,t){const r=[],n=new class extends Zc{visit(e,n){const i=Kc(e);if(!(i.start<=t&&t<i.end))return!0;r.push(e)}};return Jc(n,e),new Yc.AstPath(r,t)};var el={},tl={},rl={};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
Object.defineProperty(rl,"__esModule",{value:!0}),rl.assertArrayOfStrings=function(e,t){if(null!=t){if(!Array.isArray(t))throw new Error("Expected '".concat(e,"' to be an array of strings."));for(let r=0;r<t.length;r+=1)if("string"!=typeof t[r])throw new Error("Expected '".concat(e,"' to be an array of strings."))}};const nl=[/^\s*$/,/[<>]/,/^[{}]$/,/&(#|[a-z])/i,/^\/\//];rl.assertInterpolationSymbols=function(e,t){if(!(null==t||Array.isArray(t)&&2==t.length))throw new Error("Expected '".concat(e,"' to be an array, [start, end]."));if(null!=t){const e=t[0],r=t[1];nl.forEach((t=>{if(t.test(e)||t.test(r))throw new Error("['".concat(e,"', '").concat(r,"'] contains unusable interpolation symbol."))}))}},function(e){
/**
   * @license
   * Copyright Google Inc. All Rights Reserved.
   *
   ...
   * found in the LICENSE file at https://angular.io/license
   */
Object.defineProperty(e,"__esModule",{value:!0});const t=rl;class r{constructor(e,t){this.start=e,this.end=t}static fromArray(n){return n?(t.assertInterpolationSymbols("interpolation",n),new r(n[0],n[1])):e.DEFAULT_INTERPOLATION_CONFIG}}e.InterpolationConfig=r,e.DEFAULT_INTERPOLATION_CONFIG=new r("{{","}}")}(tl),function(e){
/**
   * @license
   * Copyright Google Inc. All Rights Reserved.
   *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
Object.defineProperty(Hc,"__esModule",{value:!0});const il=t,sl=zc,ol=el,al=jc;class ul extends il.ParseError{constructor(e,t,r){super(t,r),this.elementName=e}static create(e,t,r){return new ul(e,t,r)}}Hc.TreeError=ul;class cl{constructor(e,t){this.rootNodes=e,this.errors=t}}Hc.ParseTreeResult=cl;Hc.Parser=class{constructor(e){this.getTagDefinition=e}parse(e,t,r){let n=arguments.length>3&&void 0!==arguments[3]&&arguments[3],i=arguments.length>4?arguments[4]:void 0;const s=e=>function(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return e(t.toLowerCase(),...n)},o=n?this.getTagDefinition:s(this.getTagDefinition),a=e=>o(e).contentType,u=n?i:s(i),c=i?(e,t,r,n)=>{const i=u(e,t,r,n);return void 0!==i?i:a(e)}:a,l=ol.tokenize(e,t,c,r),p=r&&r.canSelfClose||!1,h=r&&r.allowHtmComponentClosingTags||!1,D=new ll(l.tokens,o,p,h,n).build();return new cl(D.rootNodes,l.errors.concat(D.errors))}};class ll{constructor(e,t,r,n,i){this.tokens=e,this.getTagDefinition=t,this.canSelfClose=r,this.allowHtmComponentClosingTags=n,this.isTagNameCaseSensitive=i,this._index=-1,this._rootNodes=[],this._errors=[],this._elementStack=[],this._advance()}build(){for(;this._peek.type!==ol.TokenType.EOF;)this._peek.type===ol.TokenType.TAG_OPEN_START?this._consumeStartTag(this._advance()):this._peek.type===ol.TokenType.TAG_CLOSE?(this._closeVoidElement(),this._consumeEndTag(this._advance())):this._peek.type===ol.TokenType.CDATA_START?(this._closeVoidElement(),this._consumeCdata(this._advance())):this._peek.type===ol.TokenType.COMMENT_START?(this._closeVoidElement(),this._consumeComment(this._advance())):this._peek.type===ol.TokenType.TEXT||this._peek.type===ol.TokenType.RAW_TEXT||this._peek.type===ol.TokenType.ESCAPABLE_RAW_TEXT?(this._closeVoidElement(),this._consumeText(this._advance())):this._peek.type===ol.TokenType.EXPANSION_FORM_START?this._consumeExpansion(this._advance()):this._peek.type===ol.TokenType.DOC_TYPE_START?this._consumeDocType(this._advance()):this._advance();return new cl(this._rootNodes,this._errors)}_advance(){const e=this._peek;return this._index<this.tokens.length-1&&this._index++,this._peek=this.tokens[this._index],e}_advanceIf(e){return this._peek.type===e?this._advance():null}_consumeCdata(e){const t=this._advance(),r=this._getText(t),n=this._advanceIf(ol.TokenType.CDATA_END);this._addToParent(new sl.CDATA(r,new il.ParseSourceSpan(e.sourceSpan.start,(n||t).sourceSpan.end)))}_consumeComment(e){const t=this._advanceIf(ol.TokenType.RAW_TEXT),r=this._advanceIf(ol.TokenType.COMMENT_END),n=null!=t?t.parts[0].trim():null,i=new il.ParseSourceSpan(e.sourceSpan.start,(r||t||e).sourceSpan.end);this._addToParent(new sl.Comment(n,i))}_consumeDocType(e){const t=this._advanceIf(ol.TokenType.RAW_TEXT),r=this._advanceIf(ol.TokenType.DOC_TYPE_END),n=null!=t?t.parts[0].trim():null,i=new il.ParseSourceSpan(e.sourceSpan.start,(r||t||e).sourceSpan.end);this._addToParent(new sl.DocType(n,i))}_consumeExpansion(e){const t=this._advance(),r=this._advance(),n=[];for(;this._peek.type===ol.TokenType.EXPANSION_CASE_VALUE;){const e=this._parseExpansionCase();if(!e)return;n.push(e)}if(this._peek.type!==ol.TokenType.EXPANSION_FORM_END)return void this._errors.push(ul.create(null,this._peek.sourceSpan,"Invalid ICU message. Missing '}'."));const i=new il.ParseSourceSpan(e.sourceSpan.start,this._peek.sourceSpan.end);this._addToParent(new sl.Expansion(t.parts[0],r.parts[0],n,i,t.sourceSpan)),this._advance()}_parseExpansionCase(){const e=this._advance();if(this._peek.type!==ol.TokenType.EXPANSION_CASE_EXP_START)return this._errors.push(ul.create(null,this._peek.sourceSpan,"Invalid ICU message. Missing '{'.")),null;const t=this._advance(),r=this._collectExpansionExpTokens(t);if(!r)return null;const n=this._advance();r.push(new ol.Token(ol.TokenType.EOF,[],n.sourceSpan));const i=new ll(r,this.getTagDefinition,this.canSelfClose,this.allowHtmComponentClosingTags,this.isTagNameCaseSensitive).build();if(i.errors.length>0)return this._errors=this._errors.concat(i.errors),null;const s=new il.ParseSourceSpan(e.sourceSpan.start,n.sourceSpan.end),o=new il.ParseSourceSpan(t.sourceSpan.start,n.sourceSpan.end);return new sl.ExpansionCase(e.parts[0],i.rootNodes,s,e.sourceSpan,o)}_collectExpansionExpTokens(e){const t=[],r=[ol.TokenType.EXPANSION_CASE_EXP_START];for(;;){if(this._peek.type!==ol.TokenType.EXPANSION_FORM_START&&this._peek.type!==ol.TokenType.EXPANSION_CASE_EXP_START||r.push(this._peek.type),this._peek.type===ol.TokenType.EXPANSION_CASE_EXP_END){if(!pl(r,ol.TokenType.EXPANSION_CASE_EXP_START))return this._errors.push(ul.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;if(r.pop(),0==r.length)return t}if(this._peek.type===ol.TokenType.EXPANSION_FORM_END){if(!pl(r,ol.TokenType.EXPANSION_FORM_START))return this._errors.push(ul.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;r.pop()}if(this._peek.type===ol.TokenType.EOF)return this._errors.push(ul.create(null,e.sourceSpan,"Invalid ICU message. Missing '}'.")),null;t.push(this._advance())}}_getText(e){let t=e.parts[0];if(t.length>0&&"\n"==t[0]){const e=this._getParentElement();null!=e&&0==e.children.length&&this.getTagDefinition(e.name).ignoreFirstLf&&(t=t.substring(1))}return t}_consumeText(e){const t=this._getText(e);t.length>0&&this._addToParent(new sl.Text(t,e.sourceSpan))}_closeVoidElement(){const e=this._getParentElement();e&&this.getTagDefinition(e.name).isVoid&&this._elementStack.pop()}_consumeStartTag(e){const t=e.parts[0],r=e.parts[1],n=[];for(;this._peek.type===ol.TokenType.ATTR_NAME;)n.push(this._consumeAttr(this._advance()));const i=this._getElementFullName(t,r,this._getParentElement());let s=!1;if(this._peek.type===ol.TokenType.TAG_OPEN_END_VOID){this._advance(),s=!0;const t=this.getTagDefinition(i);this.canSelfClose||t.canSelfClose||null!==al.getNsPrefix(i)||t.isVoid||this._errors.push(ul.create(i,e.sourceSpan,'Only void and foreign elements can be self closed "'.concat(e.parts[1],'"')))}else this._peek.type===ol.TokenType.TAG_OPEN_END&&(this._advance(),s=!1);const o=this._peek.sourceSpan.start,a=new il.ParseSourceSpan(e.sourceSpan.start,o),u=new il.ParseSourceSpan(e.sourceSpan.start.moveBy(1),e.sourceSpan.end),c=new sl.Element(i,n,[],a,a,void 0,u);this._pushElement(c),s&&(this._popElement(i),c.endSourceSpan=a)}_pushElement(e){const t=this._getParentElement();t&&this.getTagDefinition(t.name).isClosedByChild(e.name)&&this._elementStack.pop(),this._addToParent(e),this._elementStack.push(e)}_consumeEndTag(e){const t=this.allowHtmComponentClosingTags&&0===e.parts.length?null:this._getElementFullName(e.parts[0],e.parts[1],this._getParentElement());if(this._getParentElement()&&(this._getParentElement().endSourceSpan=e.sourceSpan),t&&this.getTagDefinition(t).isVoid)this._errors.push(ul.create(t,e.sourceSpan,'Void elements do not have end tags "'.concat(e.parts[1],'"')));else if(!this._popElement(t)){const r='Unexpected closing tag "'.concat(t,'". It may happen when the tag has already been closed by another tag. For more info see https://www.w3.org/TR/html5/syntax.html#closing-elements-that-have-implied-end-tags');this._errors.push(ul.create(t,e.sourceSpan,r))}}_popElement(e){for(let t=this._elementStack.length-1;t>=0;t--){const r=this._elementStack[t];if(!e||(al.getNsPrefix(r.name)?r.name==e:r.name.toLowerCase()==e.toLowerCase()))return this._elementStack.splice(t,this._elementStack.length-t),!0;if(!this.getTagDefinition(r.name).closedByParent)return!1}return!1}_consumeAttr(e){const t=al.mergeNsAndName(e.parts[0],e.parts[1]);let r,n,i=e.sourceSpan.end,s="";if(this._peek.type===ol.TokenType.ATTR_QUOTE){n=this._advance().sourceSpan.start}if(this._peek.type===ol.TokenType.ATTR_VALUE){const e=this._advance();s=e.parts[0],i=e.sourceSpan.end,r=e.sourceSpan}if(this._peek.type===ol.TokenType.ATTR_QUOTE){i=this._advance().sourceSpan.end,r=new il.ParseSourceSpan(n,i)}return new sl.Attribute(t,s,new il.ParseSourceSpan(e.sourceSpan.start,i),r,e.sourceSpan)}_getParentElement(){return this._elementStack.length>0?this._elementStack[this._elementStack.length-1]:null}_getParentElementSkippingContainers(){let e=null;for(let t=this._elementStack.length-1;t>=0;t--){if(!al.isNgContainer(this._elementStack[t].name))return{parent:this._elementStack[t],container:e};e=this._elementStack[t]}return{parent:null,container:e}}_addToParent(e){const t=this._getParentElement();null!=t?t.children.push(e):this._rootNodes.push(e)}_insertBeforeContainer(e,t,r){if(t){if(e){const n=e.children.indexOf(t);e.children[n]=r}else this._rootNodes.push(r);r.children.push(t),this._elementStack.splice(this._elementStack.indexOf(t),0,r)}else this._addToParent(r),this._elementStack.push(r)}_getElementFullName(e,t,r){return""===e&&""===(e=this.getTagDefinition(t).implicitNamespacePrefix||"")&&null!=r&&(e=al.getNsPrefix(r.name)),al.mergeNsAndName(e,t)}}function pl(e,t){return e.length>0&&e[e.length-1]===t}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */Object.defineProperty($c,"__esModule",{value:!0});const hl=Mc,Dl=Hc;var dl=Hc;$c.ParseTreeResult=dl.ParseTreeResult,$c.TreeError=dl.TreeError;class fl extends Dl.Parser{constructor(){super(hl.getHtmlTagDefinition)}parse(e,t,r){let n=arguments.length>3&&void 0!==arguments[3]&&arguments[3],i=arguments.length>4?arguments[4]:void 0;return super.parse(e,t,r,n,i)}}$c.HtmlParser=fl,Object.defineProperty(qc,"__esModule",{value:!0});const gl=$c,ml=jc;qc.TagContentType=ml.TagContentType;let El=null;const Cl=()=>(El||(El=new gl.HtmlParser),El);qc.parse=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};const{canSelfClose:r=!1,allowHtmComponentClosingTags:n=!1,isTagNameCaseSensitive:i=!1,getTagContentType:s}=t;return Cl().parse(e,"angular-html-parser",{tokenizeExpansionForms:!1,interpolationConfig:void 0,canSelfClose:r,allowHtmComponentClosingTags:n},i,s)};const{ParseSourceSpan:yl,ParseLocation:bl,ParseSourceFile:Sl}=t,Tl=E,_l=C,vl=y,{inferParserByLanguage:Al}=Ua,{HTML_ELEMENT_ATTRIBUTES:Fl,HTML_TAGS:wl,isUnknownNamespace:kl}=vc,{hasPragma:Nl}=Ac,{Node:Ol}=Ic,{parseIeConditionalComment:xl}=Lc,{locStart:Il,locEnd:Pl}=Bc;function Rl(e,r,n){let{recognizeSelfClosing:i,normalizeTagName:s,normalizeAttributeName:o,allowHtmComponentClosingTags:a,isTagNameCaseSensitive:u,getTagContentType:c}=r;const l=qc,{RecursiveVisitor:p,visitAll:h}=zc,{ParseSourceSpan:D}=t,{getHtmlTagDefinition:d}=Mc;let{rootNodes:f,errors:g}=l.parse(e,{canSelfClose:i,allowHtmComponentClosingTags:a,isTagNameCaseSensitive:u,getTagContentType:c});if("vue"===n.parser){if(f.some((e=>"docType"===e.type&&"html"===e.value||"element"===e.type&&"html"===e.name.toLowerCase()))){i=!0,s=!0,o=!0,a=!0,u=!1;const t=l.parse(e,{canSelfClose:i,allowHtmComponentClosingTags:a,isTagNameCaseSensitive:u});f=t.rootNodes,g=t.errors}else{const t=e=>{if(!e)return!1;if("element"!==e.type||"template"!==e.name)return!1;const t=e.attrs.find((e=>"lang"===e.name)),r=t&&t.value;return!r||"html"===Al(r,n)};if(f.some(t)){let r;const n=()=>l.parse(e,{canSelfClose:i,allowHtmComponentClosingTags:a,isTagNameCaseSensitive:u}),s=()=>r||(r=n()),o=e=>s().rootNodes.find((t=>{let{startSourceSpan:r}=t;return r&&r.start.offset===e.startSourceSpan.start.offset}));for(let e=0;e<f.length;e++){const r=f[e],{endSourceSpan:n,startSourceSpan:i}=r;if(null===n){g=s().errors,f[e]=o(r)||r}else if(t(r)){const t=s(),a=i.end.offset,u=n.start.offset;for(const e of t.errors){const{offset:t}=e.span.start;if(a<t&&t<u){g=[e];break}}f[e]=o(r)||r}}}}}if(g.length>0){const{msg:e,span:{start:t,end:r}}=g[0];throw vl(e,{start:{line:t.line+1,column:t.col+1},end:{line:r.line+1,column:r.col+1}})}const m=e=>{const t=e.name.startsWith(":")?e.name.slice(1).split(":")[0]:null,r=e.nameSpan.toString(),n=null!==t&&r.startsWith("".concat(t,":")),i=n?r.slice(t.length+1):r;e.name=i,e.namespace=t,e.hasExplicitNamespace=n},E=(e,t)=>{const r=e.toLowerCase();return t(r)?r:e};return h(new class extends p{visit(e){(e=>{if("element"===e.type){m(e);for(const t of e.attrs)m(t),t.valueSpan?(t.value=t.valueSpan.toString(),/["']/.test(t.value[0])&&(t.value=t.value.slice(1,-1))):t.value=null}else"comment"===e.type?e.value=e.sourceSpan.toString().slice("\x3c!--".length,-"--\x3e".length):"text"===e.type&&(e.value=e.sourceSpan.toString())})(e),(e=>{if("element"===e.type){const t=d(u?e.name:e.name.toLowerCase());!e.namespace||e.namespace===t.implicitNamespacePrefix||kl(e)?e.tagDefinition=t:e.tagDefinition=d("")}})(e),(e=>{if("element"===e.type&&(!s||e.namespace&&e.namespace!==e.tagDefinition.implicitNamespacePrefix&&!kl(e)||(e.name=E(e.name,(e=>e in wl))),o)){const t=Fl[e.name]||Object.create(null);for(const r of e.attrs)r.namespace||(r.name=E(r.name,(r=>e.name in Fl&&(r in Fl["*"]||r in t))))}})(e),(e=>{e.sourceSpan&&e.endSourceSpan&&(e.sourceSpan=new D(e.sourceSpan.start,e.endSourceSpan.end))})(e)}},f),f}function Ll(e,t,r){let n=!(arguments.length>3&&void 0!==arguments[3])||arguments[3];const{frontMatter:i,content:s}=n?Tl(e):{frontMatter:null,content:e},o=new Sl(e,t.filepath),a=new bl(o,0,0,0),u=a.moveBy(e.length),c={type:"root",sourceSpan:new yl(a,u),children:Rl(s,r,t)};if(i){const e=new bl(o,0,0,0),t=e.moveBy(i.raw.length);i.sourceSpan=new yl(e,t),c.children.unshift(i)}const l=new Ol(c),p=(n,i)=>{const{offset:s}=i,o=Ll(e.slice(0,s).replace(/[^\n\r]/g," ")+n,t,r,!1);o.sourceSpan=new yl(i,_l(o.children).sourceSpan.end);const a=o.children[0];return a.length===s?o.children.shift():(a.sourceSpan=new yl(a.sourceSpan.start.moveBy(s),a.sourceSpan.end),a.value=a.value.slice(s)),o};return l.map((e=>{if("comment"===e.type){const t=xl(e,p);if(t)return t}return e}))}function Bl(){let{name:e,recognizeSelfClosing:t=!1,normalizeTagName:r=!1,normalizeAttributeName:n=!1,allowHtmComponentClosingTags:i=!1,isTagNameCaseSensitive:s=!1,getTagContentType:o}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return{parse:(a,u,c)=>Ll(a,Object.assign({parser:e},c),{recognizeSelfClosing:t,normalizeTagName:r,normalizeAttributeName:n,allowHtmComponentClosingTags:i,isTagNameCaseSensitive:s,getTagContentType:o}),hasPragma:Nl,astFormat:"html",locStart:Il,locEnd:Pl}}var ql={parsers:{html:Bl({name:"html",recognizeSelfClosing:!0,normalizeTagName:!0,normalizeAttributeName:!0,allowHtmComponentClosingTags:!0}),angular:Bl({name:"angular"}),vue:Bl({name:"vue",recognizeSelfClosing:!0,isTagNameCaseSensitive:!0,getTagContentType:(e,t,r,n)=>{if("html"!==e.toLowerCase()&&!r&&("template"!==e||n.some((e=>{let{name:t,value:r}=e;return"lang"===t&&"html"!==r}))))return qc.TagContentType.RAW_TEXT}}),lwc:Bl({name:"lwc"})}};export{ql as default};
