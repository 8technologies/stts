                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <small>Joined on: <?php echo e(Admin::user()->created_at, false); ?></small>
                            </p>
                        </li>

                        <li class="user-footer" style="background-color: #008140;">
                            <div class="pull-left">
                                <a href="<?php echo e(admin_url('auth/setting'), false); ?>" class="btn btn-default"><?php echo e(trans('admin.setting'), false); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo e(admin_url('auth/logout'), false); ?>" class="btn btn-default"><?php echo e(trans('admin.logout'), false); ?></a>
                            </div>
                        </li>
                    </ul>
                </li>
...
</header><?php /**PATH C:\Users\Cole\Desktop\8Projects\stts\vendor\encore\laravel-admin\src/../resources/views/partials/header.blade.php ENDPATH**/ ?>