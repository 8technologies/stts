...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo e(admin_url('/'), false); ?>"><b><?php echo e(trans(config('admin.name')), false); ?></b></a>
  </div>
  <!-- /.login-logo -->
      ...
      <div class="form-group">
        <select class="form-control" id="locale">
          <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($key, false); ?>" <?php echo $key != $current ?: 'selected'; ?>><?php echo e($language, false); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
    </form>
...
<script>
  $(function () {
    ...
    $("#locale").change(function () {
      ...
      $.post("<?php echo e(admin_url('/locale'), false); ?>",{locale: locale}, function () {
        location.reload();
      })
    });
  });
...
<?php /**PATH C:\xampp\htdocs\stts\vendor\laravel-admin-extensions\multi-language\src/../resources/views/login.blade.php ENDPATH**/ ?>