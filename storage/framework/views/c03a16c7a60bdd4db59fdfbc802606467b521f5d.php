<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                <!-- Status -->
                <a href="#"><i class="fa fa-check text-success"></i> <?php echo e(trans('admin.online'), false); ?></a>
            </div>
        </div>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\Users\Cole\Desktop\8Projects\stts\vendor\encore\laravel-admin\src/../resources/views/partials/sidebar.blade.php ENDPATH**/ ?>