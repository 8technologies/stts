    ...
    <table class="table table-bordered" style="border-color: black!important;">
        <tbody>
            <tr>
                ...
                <td>
                    <p class="text-center"><?php echo e($form->updated_at, false); ?></p>
                </td>
                <th width="25%">
                <p>Lab Test Number</p>
                </th>
                <td>
                    <p class="text-center"><?php echo e($form->lab_test_number, false); ?></p>
                </td>
            </tr>
            <tr>
                <th width="20%" class="text-left">
                ...
                <td>
                    <p class="text-center"><?php echo e($form->lot_number, false); ?> </p>
                </td>
                <th width="25%">
                    Status
                </th>
                <td>
                    <p class="text-center"> <?php echo e($status, false); ?></p>
                </td>
            </tr>
            <tr>
                <th width="20%" class="text-left">
                ...
                <td>
                    <p class="text-center"> <?php echo e($crop_variety, false); ?> </p>
                </td>
                <td width="25%">
                    <p><b>Weight of Lot:</b></p>
                </td>
                <td>
                    <p class="text-center"><?php echo e($form->quantity, false); ?> kgs</p>
                </td>
            </tr>
        </tbody>
    </table>
    <table class="table table-bordered">
        <tbody>
            ...
            <td><?php echo e($form->purity, false); ?> %</td>
                <td><?php echo e($form->inert_matter, false); ?> %</td>
                <td><?php echo e($form->other_crop_seeds, false); ?> %</td>
                <td><?php echo e($form->weed_seed, false); ?> %</td>
                <td><?php echo e($form->first_count, false); ?></td>
                <td><?php echo e($form->final_count, false); ?></td>
                <td><?php echo e($form->hard, false); ?> %</td>
                <td><?php echo e($form->fresh, false); ?> %</td>
                <td><?php echo e($form->dead, false); ?> %</td>
                <td>...</td>
                <td>...</td>
                <td><?php echo e($form->moisture, false); ?> %</td>
        ...
        <tr>
            ...
            <td>
                <div class=" mt-2 p-1 pl-2  w-100" style="height: 10%; width: 100%;">
                    <h2 style="border-bottom: dotted bottom 2px;" class=" h5 text-center"><?php echo e($analyst, false); ?></h2>
                    <h2  class=" h5 text-left"><i>Official Seed Tester</i></h2>
                    <h2 style="border-bottom: dotted bottom 2px;" class=" h5 text-left">DATE: <?php echo e($date, false); ?></h2>
...
<?php /**PATH C:\Users\Cole\Desktop\stts\resources\views/reports/lab_test.blade.php ENDPATH**/ ?>