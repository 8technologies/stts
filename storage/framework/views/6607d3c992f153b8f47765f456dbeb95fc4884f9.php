...
<body>
    <table class="table table-borderless ">
        <tr>
            <td>
                <p>FORM SR 12A</p>
                <p>NO. <b> <?php echo e($data['number'], false); ?> </b></p>
            </td>
    ...
    <table class="table table-bordered" style="border-color: black!important;">
        <tbody>
            <tr>
                ...
                <td>
                    <p class="text-center"> <?php echo e($data['date_received'], false); ?> </p>
                </td>
                <th width="25%">
                    TEST NUMBER
                </th>
            ...
            <tr>
                ...
                <td>
                    <p class="text-center"> <?php echo e($data['log_number'], false); ?> </p>
                </td>
                <th width="25%">
                    <?php echo e($data['cold_room'], false); ?>
            ...
            <tr>
                ...
                <td>
                    <p class="text-center"> <?php echo e($data['crop_species'], false); ?> </p>
                </td>
                <td width="25%">
                    <p><b>Wight of Lot:</b></p>
                    <p><?php echo e($data['wight_loss'], false); ?></p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <p class="text-center"> <?php echo e($data['country_of_origin'], false); ?> <small>(As stated by Seed
                            Inspector)</small></p>
                </td>
            </tr>
        </tbody>
...
<?php /**PATH C:\Users\Cole\Desktop\stts\resources\views/pdf/test.blade.php ENDPATH**/ ?>