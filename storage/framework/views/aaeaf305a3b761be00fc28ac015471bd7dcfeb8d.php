...
<body>
    ...
    <p><strong>Permit No:</strong> <?php echo e($form->permit_number, false); ?></p>
    <p><strong>Expiry date:</strong> <?php echo e($form->valid_until, false); ?></p>
    <p><strong>Permission is hereby granted to:</strong> <?php echo e($form->name, false); ?></p>
    <p><strong>of:</strong> <?php echo e($form->address, false); ?></p>
    <!-- <p><strong>with NCSC Registration No:</strong>__</p> -->
    <p><strong>to import from:</strong> <?php echo e($form->supplier_name, false); ?>, <?php echo e($form->supplier_address, false); ?></p>
    ...
    <table>
        ...
        <tbody>
        <?php $__currentLoopData = $crop_varieties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <?php
            ...
            <tr>
                <td><?php echo e($crop_name, false); ?></td>
                <td><?php echo e($crop_variety->name, false); ?></td> <!-- Access name attribute directly -->
                <td><?php echo e($crop->category, false); ?></td>
                <td><?php echo e($crop->weight, false); ?></td>
            </tr>
...
<ol>
    ...
    <li>Additional Conditions<span> <?php echo e($form->additional_conditions, false); ?></span></li>
</ol>
...
<?php /**PATH C:\Users\Cole\Desktop\stts\resources\views/reports/import_permit.blade.php ENDPATH**/ ?>